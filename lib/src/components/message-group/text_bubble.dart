...
class _TextBubbleState extends State<TextBubble> {
  ...
  @override
  void initState() {
    if (widget.message.delivered != null && widget.message.delivered == false) {
      DateTime now = DateTime.now();
      if (now.difference(widget.message.timestamp).inSeconds > 15) {
        showRetry = true;
      } else {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: MeasureSize(
        ...
        child: widget.loadUrl == null || widget.loadUrl! ? Row(
          ...
          children: [
                      ...
                      ? Padding(
                          ...
                          child: Text(
                            ...
                            style: TextStyle(
                              fontSize: 14,
                              color:
                                  rc.userColors[widget.message.senderToken] ??
                                                                  ...
                                                                  pageBuilder:
                                                                    ...
                                                                    return ImagePreview(
                                                                      attachment: widget
                                                                          .message
                                                                          .groupLinks[0],
                                                                      isLocal: !widget.message.groupDelivered[
                                                                              0] &&
                                                                          widget
                                                                              .message
                                                                              .groupFilePaths[0]
            ...
            if (widget.message.delivered != null &&
                widget.message.delivered == false &&
                showRetry && ( widget.loadUrl == null || widget.loadUrl!))
              GestureDetector(
                onTap: () {
